...
public class PrivacyActivity extends Activity {
    ...
    private View screen() {
        ...
        section(content, "Account data", "An account may contain your email, display name, username, authentication provider, Firebase UUID, activation status, and activation assignment. Firebase processes email/password and Google sign-in. Nebula's server does not receive or store your Google or email-account password.");
        ...
        section(content, "Retention and deletion", "Account records remain until you select Delete Account. Operational records are kept for no more than seven days. Delete Account immediately removes your Firebase identity and Nebula records tied to your UUID. Local mods and game files remain on the device.");
